...
class PainelAtendimento:
    ...
    def painel_atendimento(self):
        ...
        Retorna:
            int: Código da escolha do usuário validado entre 1 e 5.
        """
        print(f"\n{AZUL}+--------------------------------------------------+")
        ...
        print(f"  {NEGRITO}5.{RESET} Sair do painel de atendimento")
        print(f"{AZUL}----------------------------------------------------{RESET}")
        ...
        while True:
            try:
                ...
                if escolha < 1 or escolha > 5:
                    print(f"{VERMELHO}[ERRO] Escolha inválida. Digite um número inteiro entre 1 e 5.{RESET}")
                else: 
                    return escolha
            except ValueError:
